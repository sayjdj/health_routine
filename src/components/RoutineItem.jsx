...
// ⚡ Bolt: Memoized RoutineItem to prevent unnecessary re-renders.
// Why: RoutineList updates state (isModalOpen, editingRoutine) which would cause
//      all RoutineItems to re-render. Memoizing ensures only changed items re-render.
const RoutineItem = React.memo(function RoutineItem({ routine, onEdit, onDelete, onPlay }) {
  return (
