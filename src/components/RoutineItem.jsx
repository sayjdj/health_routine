...
// Why: RoutineList updates state (like isModalOpen or editingRoutine) which causes the list to re-render.
//      By memoizing the individual routine items, we prevent all items from re-rendering
//      when only the parent's state changes.
