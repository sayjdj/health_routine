...
// ⚡ Bolt: Extract and Memoize RoutineItem to prevent O(N) re-renders
// Why: When RoutineList state changes (e.g. modal opens), it normally re-renders
//      all items. Memoizing the individual item stops this cascading re-render.
