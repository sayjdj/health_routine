...
// ⚡ Bolt: Memoized RoutineListItem
// Why: When modifying the list (adding, deleting, editing a routine), all routines in the list would re-render.
//      By memoizing the list item, we only re-render the routine that was updated, skipping the rest.
const RoutineListItem = React.memo(({ routine, onEdit, onDelete, onPlay }) => {
  return (
