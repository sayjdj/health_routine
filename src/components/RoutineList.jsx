...
export default function RoutineList({ onSelectRoutine }) {
  ...
  // ⚡ Bolt Optimization: Memoize helper functions in RoutineList
  // Why: These functions are passed down to child components (e.g., CustomRoutineModal)
  //      or used in mapping over the routines list. Memoizing them with useCallback
  //      prevents breaking the React.memo() optimization in child components that receive them.
