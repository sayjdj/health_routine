...
// ⚡ Bolt: Memoize individual list items to prevent unnecessary O(N) re-renders
// Why: When the modal opens/closes, state changes in RoutineList cause all items
//      to re-render. Memoizing the item component along with stable callbacks prevents this.
