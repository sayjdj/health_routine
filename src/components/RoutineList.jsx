...
// ⚡ Bolt: Extract mapping logic and wrap with React.memo
// Why: Prevents re-rendering every list item when the modal opens/closes or when a single routine is edited.
