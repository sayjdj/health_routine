...
// ⚡ Bolt: Memoized RoutineItem component to prevent re-rendering list items unnecessarily
// Why: When the modal opens or a routine is updated, mapping over `routines` would re-render
//      every single routine item if they were defined inline. Extracting and memoizing this
//      component avoids those costly re-renders.
