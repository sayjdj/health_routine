...
// ⚡ Bolt Optimization: Extract RoutineItem and wrap with React.memo
// Why: Prevents all routine items from re-rendering when the parent RoutineList
//      re-renders (e.g., when the modal opens/closes or when editing a routine).
