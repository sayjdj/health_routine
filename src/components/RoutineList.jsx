...
// ⚡ Bolt: Memoized RoutineItem to prevent re-rendering the entire list when modal opens or single item is edited.
// Why: When a new routine is added or the modal opens, state changes in RoutineList.
//      React.memo prevents all unaffected list items from re-rendering.
const RoutineItem = React.memo(({ routine, onEdit, onDelete, onPlay }) => {
  return (
