...
// ⚡ Bolt Optimization: Extract RoutineItem into a React.memo component.
// Why: When CustomRoutineModal is opened/closed or editingRoutine changes, RoutineList re-renders.
//      Without memoization, every item in the routine list re-renders unnecessarily.
//      By extracting this and passing stable callbacks, we skip re-renders for unchanged items.
...
export default function RoutineList({ onSelectRoutine }) {
  ...
  }, [onSelectRoutine, requestNotificationPermission]);
