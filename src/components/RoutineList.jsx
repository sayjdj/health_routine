...
// ⚡ Bolt: Memoized RoutineListItem to prevent unnecessary re-renders.
// Why: When the modal opens/closes or other state changes in RoutineList,
//      we shouldn't re-render every item in the list if its routine data hasn't changed.
const RoutineListItem = React.memo(({ routine, onPlay, onEdit, onDelete }) => {
  return (
