...
// ⚡ Bolt: Extracted and memoized RoutineItem to prevent re-rendering all items when modal state changes
// Why: When the modal opens/closes, or we start editing one routine, we shouldn't re-render
//      the entire list of unmodified routines.
