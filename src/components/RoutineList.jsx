...
// ⚡ Bolt: Extracted RoutineItem and wrapped in React.memo
// Why: When the modal opens/closes or when `editingRoutine` state changes,
// the entire list of routines would previously re-render. Memoizing each item
// prevents these unnecessary re-renders.
