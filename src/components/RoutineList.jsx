...
// ⚡ Bolt: Extracted and memoized RoutineItem to prevent unnecessary re-renders.
// Why: When a routine is updated (or the modal opens/closes), we don't want
//      all unchanged routine items in the list to re-render. Since we now use
//      stable references for the handler callbacks, React.memo() will effectively
//      prevent cascading re-renders for items that haven't changed.
