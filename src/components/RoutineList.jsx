...
// ⚡ Bolt: Extracted and memoized RoutineItem
// Why: When the modal opens/closes, or editingRoutine state changes, the entire RoutineList re-renders.
//      By extracting and memoizing this component, and passing it stable callbacks, we prevent
//      all non-edited routines from needlessly re-rendering.
...
export default function RoutineList({ onSelectRoutine }) {
  ...
  // This is required so RoutineItem's React.memo actually works
