...
// ⚡ Bolt: Extract and memoize routine item to prevent cascading re-renders
// Why: When the modal opens/closes, RoutineList re-renders. By memoizing the items
//      and passing stable callbacks, we avoid re-rendering all list items unnecessarily.
