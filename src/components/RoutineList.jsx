...
// ⚡ Bolt: Memoized RoutineItem to prevent unnecessary re-renders when list updates
// Why: When a new routine is added or deleted, the parent `RoutineList` re-renders.
//      Memoizing individual list items prevents all unchanged items from re-rendering.
