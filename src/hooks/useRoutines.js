...
export function useRoutines() {
  ...
  // ⚡ Bolt: Wrap return functions in useCallback with functional state updates.
  // Why: Prevents recreating these functions on every render (which cascades re-renders
  //      to child components that receive them as props, like RoutineItem).
