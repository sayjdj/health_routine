...
export function useRoutines() {
  ...
  // ⚡ Bolt: Wrap functions in useCallback with functional state updates
  // Why: Provides stable references so child components using these don't unnecessarily re-render
