...
export function useRoutines() {
  ...
  // ⚡ Bolt: Memoized callbacks with functional state updates
  // Why: Passing stable function references down to components prevents unnecessary re-renders.
  //      Using functional state updates allows the callbacks to have no dependencies,
  //      so they never change reference.
