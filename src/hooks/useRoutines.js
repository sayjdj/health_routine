...
export function useRoutines() {
  ...
  // ⚡ Bolt: Wrap with useCallback and use functional state updates to provide stable references.
  // Why: Prevents breaking React.memo in child components that receive these callbacks.
