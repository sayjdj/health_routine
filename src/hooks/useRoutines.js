...
export function useRoutines() {
  ...
  // ⚡ Bolt: Memoize hook functions with useCallback to provide stable references.
  // Why: Prevents unnecessary re-renders of components consuming these functions
  //      when they are passed down as props.
