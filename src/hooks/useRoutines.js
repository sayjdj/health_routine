...
export function useRoutines() {
  ...
  // ⚡ Bolt: Wrapped state mutators with useCallback and functional state updates.
  // Why: By using `prev => ...`, we remove the dependency on `routines`.
  //      This provides stable function references that can be passed down without triggering re-renders in memoized children.
