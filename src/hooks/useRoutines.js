...
export function useRoutines() {
  ...
  // ⚡ Bolt Optimization: Wrap functions in useCallback and use functional state updates.
  // This prevents the functions from being recreated on every render and provides
  // stable references to child components like RoutineList, enabling effective memoization.
