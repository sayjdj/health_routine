...
export function useRoutines() {
  ...
  // ⚡ Bolt: Memoized useRoutines callbacks and used functional state updates
  // Why: Prevents creating new function instances on every render.
  //      Functional state updates prevent closures from capturing stale state and allow dropping `routines` dependency.
